...
<div class="w3-container w3-center w3-round w3-text-hover-light-blue fa fa-remove">
    <h1 style="color:lightskyblue" class="text w3-animate-fading w3-animate-opacity">NEW Company</h1>
</div>
<form class="container m3-center" method="POST" action="${pageContext.request.contextPath}/addNewCompany">
    <nav class="w3-bar-block  w3-light-grey w3-animate-top w3-card w3-round w3-display-bottommiddle">
        <table class="w3-table-all w3-card-4 w3-small w3-margin-top w3-round w3-centered" id="myTable">
            <tr>
                <td>ID</td>
                <td><label>
                    <input type="text" name="id" placeholder=" Enter ID " value="${company.id}"/>
                </label></td>
            </tr>
            <tr>
                <td>Name</td>
            ...
            <tr>
                <td>City</td>
                <td><label>
                    <input type="text" name="city" placeholder=" Enter City " value="${company.city}"/>
                </label></td>
            </tr>
            <tr>
                <td><a href="companyList" class="w3-btn w3-hover-red w3-round-xlarge">Cancel</a></td>
                <td colspan="1">
