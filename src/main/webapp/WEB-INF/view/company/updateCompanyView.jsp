...
<c:if test="${not empty company}">
    <form method="POST" action="${pageContext.request.contextPath}/updateCompany">
        <input type="hidden" name="id" value="${company.id}"/>
        <div class="w3-container w3-center w3-round w3-text-hover-light-blue fa fa-remove">
            <h1 style="color:lightskyblue" class="text w3-animate-fading w3-animate-opacity">Update Company</h1>
        </div>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input type="submit" class="w3-input w3-border w3-hover-green w3-round-xlarge w3-light-blue"
                               value="Submit"><a href="companyList"></a>
                    </td>
                </tr>
            </table>
            <div>
