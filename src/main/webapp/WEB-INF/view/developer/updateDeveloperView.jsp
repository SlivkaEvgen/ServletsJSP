...
<c:if test="${not empty developer}">
    <form method="POST" action="${pageContext.request.contextPath}/updateDeveloper">
        <div class="w3-container w3-center w3-round w3-text-hover-light-blue fa fa-remove">
            <h1 style="color:lightskyblue" class="text w3-animate-fading w3-animate-opacity">Update Developer</h1>
        </div>
        <input type="hidden" name="id" placeholder="Enter Name " value="${developer.id}"/>
        <nav class="w3-bar-block  w3-light-grey w3-animate-top w3-card w3-round w3-display-bottommiddle">
            <table class="w3-table-all w3-card-4 w3-small w3-margin-top w3-round w3-centered" border="0">
                ...
                <tr>
                    <td>Name</td>
                    <td><label>
                        <input type="text" name="name" placeholder="Enter Name " value="${developer.name}"/>
                    </label></td>
                </tr>
                <tr>
                    <td>Age</td>
                    <td><label>
                        <input type="text" name="age" placeholder="Enter Age numbers " value="${developer.age}"/>
                    </label></td>
                </tr>
                <tr>
                    <td>Gender</td>
                    <td><label>
                        <input type="text" name="gender" placeholder="Enter Male or Female "
                ...
                <tr>
                    <td>Email</td>
                    <td><label>
                        <input type="text" name="email" placeholder="Enter Email with @  " value="${developer.email}"/>
                    </label></td>
                </tr>
                <tr>
                    <td>Salary</td>
                    <td><label>
                        <input type="text" name="salary" placeholder="Enter Salary numbers "
                ...
                <tr>
                    ...
                    <td><label>
                        <input type="text" name="companyId" placeholder="Enter Company ID  "
                               value="${developer.companyId}"/>
                    </label></td>
                </tr>
                <tr>
                    <td><a href="developerList" class="w3-btn w3-hover-red w3-round-xlarge">Cancel</a></td>
                    <td colspan="1">
                        <input type="submit" class="w3-input w3-border w3-hover-green w3-round-xlarge w3-light-blue"
                               value="Submit"><a href="developerList"></a>
                    </td>
                </tr>
            </table>
            <div>
