...
<div class="w3-container w3-center w3-round w3-text-hover-light-blue fa fa-remove">
    <h2 style="color:lightskyblue" class="text w3-animate-fading w3-animate-opacity">Developers</h2>
    <div class="w3-container w3-center">
        <a href="bySkillActivity" class="w3-btn w3-hover-light-blue w3-round-xlarge">By Activity</a>
    ...
    <div class="w3-container w3-center w3-round w3-text-hover-light-blue fa fa-remove">
        <a href="addNewDeveloper" class="w3-btn w3-btn w3-hover-light-blue w3-round-xlarge w3-center">Add New
            Developer</a>
    </div>
