...
<div class="w3-container w3-center w3-round w3-text-hover-light-blue fa fa-remove">
    <h1 style="color:lightskyblue" class="text w3-animate-fading w3-animate-opacity">NEW Project</h1>
</div>
<form class="container m3-center" method="POST" action="${pageContext.request.contextPath}/addNewProject">
    <nav class="w3-bar-block  w3-light-grey w3-animate-top w3-card w3-round w3-display-bottommiddle">
        <table class="w3-table-all w3-card-4 w3-small w3-margin-top w3-round w3-centered" id="myTable">
            <tr>
                <td>ID</td>
                <td><label>
                    <input type="text" name="id" placeholder=" Enter ID " value="${project.id}"/>
                </label></td>
            </tr>
            <tr>
                <td>Name</td>
            ...
            <tr>
                <td>Company ID</td>
                <td><label>
                    <input type="text" name="companyId" placeholder=" Enter Company ID " value="${project.companyId}"/>
                </label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td><a href="projectList" class="w3-btn w3-hover-red w3-round-xlarge">Cancel</a></td>
                <td colspan="1">
