...
<div class="w3-container w3-center w3-round w3-text-hover-light-blue fa fa-remove">
    ...
    <a href="addNewProject" class="w3-btn w3-btn w3-hover-light-blue w3-round-xlarge w3-center">Add New Project</a>
    ...
    <table class="w3-hoverable w3-padding 16 w3-table-all w3-card-4 w3-small w3-margin-top w3-round w3-centered"
        ...
        <c:forEach items="${projectList}" var="project">
            <tr>
                ...
                <td>
                    <a href="updateProject?id=${project.id}"
                       class="w3-btn w3-hover-light-blue w3-round-xlarge">Update</a>
                </td>
                <td>
                    <a href="deleteProject?id=${project.id}" class="w3-btn w3-hover-red w3-round-xlarge">Delete</a>
                </td>
            </tr>
        </c:forEach>
    </table>
