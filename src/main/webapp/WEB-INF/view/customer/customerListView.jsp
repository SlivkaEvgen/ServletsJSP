...
<div class="w3-container w3-center w3-round">
    <div class="w3-container w3-center w3-round w3-text-hover-light-blue fa fa-remove">
        <h2 style="color:lightskyblue" class="text w3-animate-fading">Customers</h2>
    </div>
    <a href="addNewCustomer" class="w3-btn w3-btn w3-hover-light-blue w3-round-xlarge w3-center">Add New Customer</a>
    ...
    <table class="w3-hoverable w3-padding 16 w3-table-all w3-card-4 w3-small w3-margin-top w3-round w3-centered w3-animate-opacity"
        ...
        <c:forEach items="${customerList}" var="customer">
            <tr>
                ...
                <td>
                    <a href="updateCustomer?id=${customer.id}"
                       class="w3-btn w3-btn w3-hover-light-blue w3-round-xlarge">Update</a>
                </td>
                <td>
                    <a href="deleteCustomer?id=${customer.id}"
                       class="w3-btn w3-btn w3-hover-red w3-round-xlarge">Delete</a>
                </td>
            </tr>
        </c:forEach>
    </table>
